...
logit-agent.sinks.logit-http-sink.channel = memory-channel`}
      ...
      <footer style={{ background: 'var(--bg-sidebar)', borderTop: '1px solid var(--border-color)', padding: '40px 80px', textAlign: 'center', fontSize: '0.8rem', color: 'var(--text-muted)', transition: 'background-color var(--transition-normal), border-color var(--transition-normal)' }}>
